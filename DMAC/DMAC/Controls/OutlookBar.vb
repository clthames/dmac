...
#Region "OutlookBarButtons list"
        Public Class OutlookBarButtons
            ...
            Public Function Add() As OutlookBarButton
                Return Me.Add()
            End Function
            Public Function Add(ByVal text As String, ByVal shortcutType As String, ByVal shortcutFor As String, ByVal linkTo As String, ByVal image As Image) As OutlookBarButton
                Dim b As OutlookBarButton = New OutlookBarButton(Me.m_parent)
                b.Text = text
                b.ShortcutType = shortcutType
                b.ShortcutFor = shortcutFor
                b.LinkTo = linkTo
                b.Image = image
                Me.Add(b)
                Return b
            End Function
            Public Function Add(ByVal text As String, ByVal shortcutType As String, ByVal shortcutFor As String, ByVal linkTo As String) As OutlookBarButton
                Dim b As OutlookBarButton = New OutlookBarButton(Me.m_parent)
                b.Text = text
                b.ShortcutType = shortcutType
                b.ShortcutFor = shortcutFor
            ...
            End Function
            Public Function GetButtons() As ArrayList
                Dim outbuttons As New ArrayList
                Dim i As Int16 = 0
                For Each obj As OutlookBarButton In List
                    outbuttons.Add(DirectCast(obj, OutlookBarButton))
                Next
                Return outbuttons
            End Function
...
#Region "OutlookBarButton"
    Public Class OutlookBarButton ' : IComponent
        ...
        Public Property Text() As String
            ...
            End Set
        End Property
        Protected m_shortcutType As String
        <Description("Shortcut Type"), Category("Appearance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)> _
        Public Property ShortcutType() As String
            Get
                Return m_shortcutType
            End Get
            Set(ByVal value As String)
                m_shortcutType = value
                m_parent.Invalidate()
            End Set
        End Property
        Protected m_shortcutFor As String
        <Description("Shortcut For"), Category("Appearance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)> _
        Public Property ShortcutFor() As String
            Get
                Return m_shortcutFor
            End Get
            Set(ByVal value As String)
                m_shortcutFor = value
                m_parent.Invalidate()
            End Set
        End Property
        Protected m_linkTo As String
        <Description("Link To "), Category("Appearance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)> _
